...
en: {
  ui: {
    ...
    step1title:     'MOVE',
    step1desc:      'Use ← → arrow keys to move Byte',
    step2title:     'JUMP',
    step2desc:      'Press ↑ or SPACE to jump onto ? blocks',
    step3title:     'CRUSH',
    step3desc:      'Land on a ? block to trigger a question',
    step4title:     'ANSWER',
    step4desc:      'Answer 5 questions to discover your AI persona',
    letsGo:         "LET'S GO! →",
    ...
    downloadBtn:    '🖨 PRINT TICKET',
    downloadDone:   '✅ Downloaded!',
    downloading:    '⏳ Generating...',
    playAgainBtn:   '↩ PLAY AGAIN',
    gameOverTitle:  'GAME OVER',
    gameOverSub:    'You lost all your lives on Q',
    backToStartBtn: '↩ BACK TO START',
    noMoreRetries:  'No more retries — start fresh!',
    livesCaption:   "You have 3 lives. Don't let blocks scroll off screen!",
...
es: {
  ui: {
    ...
    step1title:     'MOVER',
    step1desc:      'Usa ← → para mover a Byte',
    step2title:     'SALTAR',
    step2desc:      'Pulsa ↑ o ESPACIO para saltar sobre los bloques ?',
    step3title:     'APLASTAR',
    step3desc:      'Aterriza en un bloque ? para responder',
    step4title:     'RESPONDER',
    step4desc:      'Responde 5 preguntas para descubrir tu perfil de IA',
    letsGo:         '¡VAMOS! →',
    ...
    downloadBtn:    '🖨 IMPRIMIR TICKET',
    downloadDone:   '✅ ¡Descargado!',
    downloading:    '⏳ Generando...',
    playAgainBtn:   '↩ JUGAR DE NUEVO',
    gameOverTitle:  'FIN DEL JUEGO',
    gameOverSub:    'Perdiste todas tus vidas en la P',
    backToStartBtn: '↩ VOLVER AL INICIO',
    noMoreRetries:  '¡Sin más intentos — empieza de cero!',
    livesCaption:   '¡Tienes 3 vidas. No dejes que los bloques salgan de pantalla!',
...
ca: {
  ui: {
    ...
    step1title:     'MOURE',
    step1desc:      'Usa ← → per moure el Byte',
    step2title:     'SALTAR',
    step2desc:      'Prem ↑ o ESPAI per saltar sobre els blocs ?',
    step3title:     'AIXAFAR',
    step3desc:      'Aterra en un bloc ? per respondre',
    step4title:     'RESPONDRE',
    step4desc:      "Respon 5 preguntes per descobrir el teu perfil d'IA",
    letsGo:         "ANEM! →",
    ...
    gameOverTitle:  'FI DEL JOC',
    gameOverSub:    'Has perdut totes les vides a la P',
    backToStartBtn: '↩ TORNAR A L\'INICI',
    noMoreRetries:  'Sense més intents — comença de zero!',
    livesCaption:   "Tens 3 vides. No deixis que els blocs surtin de pantalla!",
